...
Setting up GitHub:
<ol>
    <li>Message a team lead (Aarya, Prasad) with your email so we can add you to the GitHub</li>
    ...
    <li>Congrats. Navigate to VSCode's source control, click the three dots, and click "Pull" just to test. Restart VSCode if necessary.</li>Message a team lead (Prasad, Aarya) with your email so we can add you to the GitHub</li>
</ol>

Instructions for initializing React Native project:
<ol>
    <li>If instructions unclear or don't work, message team leads (Aarya and Prasad) or Google it  </li>
